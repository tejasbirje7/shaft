...
import com.ecomm.order.model.Book;
import com.ecomm.order.service.BookService;
...
public class BookTest {
    ...
    public void testFindByAuthor() {
        ...
        Page<Book> byAuthor = bookService.findByAuthor("Rambabu Posa", null);
        assertThat(byAuthor.getTotalElements(), is(4L));

        Page<Book> byAuthor2 = bookService.findByAuthor("Mkyong", null);
