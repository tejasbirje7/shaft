...
public class UserManagementLogs {
  ...
  public static String AUTH_SAVE_IDENTITY_EXCEPTION = "Exception - {} , while saving identity for account {}";
  public static String IDENTITY_SAVE_EXCEPTION = "Exception - {} , identity exception while saving fp to i for account {}";
  ...
  public static String IDENTITY_SAVED_SUCCESSFULLY = "Saved successfully {}";
}
