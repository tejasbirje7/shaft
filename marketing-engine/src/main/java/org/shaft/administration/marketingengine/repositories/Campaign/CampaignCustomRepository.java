...
public interface CampaignCustomRepository {
  ...
  Mono<ObjectNode> getPaginatedQueryResults(int accountId, String query, int searchAfter);
  Mono<Long> updateCampaignStatus(int accountId, int campaignId, int status);
}
