...
public class ShaftJWT {
    ...
    public static void generatePKCSKeys(String keyPath) throws Exception {
        try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ShaftJWT shaftJWT = new ShaftJWT(keysPath,PKCS_LOADER, keys_path);
